...
void init_config(void)
{
    ...
    config[KEK_CFG_MEM_SPATIAL_MAP_CAPACITY]           = 65535;
    config[KEK_CFG_MEM_TILEMAP_CAPACITY]               = 256;
    config[KEK_CFG_SOUND_SOURCE_CAPACITY]              = 8;
    config[KEK_CFG_SOUND_BUFFER_CAPACITY]              = 128;
    config[KEK_CFG_SOUND_CAPACITY]                     = 1024;
}
